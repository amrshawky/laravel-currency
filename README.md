...
> **Update: exchangerate.host now requires API key, a new verion will released soon to support API keys, meanwhile please the the [withOptions](https://github.com/amrshawky/laravel-currency#other-methods) method and the add the api key as a query param https://docs.guzzlephp.org/en/stable/request-options.html#query**
